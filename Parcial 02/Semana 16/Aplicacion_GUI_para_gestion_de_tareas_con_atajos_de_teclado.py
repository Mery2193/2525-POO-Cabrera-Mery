# Tema: Aplicacion GUI para gestion de tareas con atajos de teclado
...
COLOR_FONDO = "#f7f5f2"
COLOR_BOTON = "#b5ead7"  # Verde pastel suave
COLOR_BOTON_COMPLETAR = "#cdb4db"  # morado clarito
COLOR_BOTON_ELIMINAR = "#f8c8dc"  # rosado pastel
COLOR_BOTON_SALIR = "#fff5ba"  # Amarillo pastel
...
class AppTareas:
    def __init__(self, root):
        self.root = root
        self.root.title("Aplicación GUI para Gestión de Tareas - por Mery Jaqueline Cabrera Herrera")
    ...
    def crear_widgets(self):
        ...
        self.label_autor = tk.Label(self.root, text="Creado por Mery Jaqueline Cabrera Herrera",
                                    bg=COLOR_FONDO, fg="#a06cd5", font=FUENTE_AUTOR)  # morado clarito en el autor
